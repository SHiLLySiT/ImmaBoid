package immaboid.behaviors 
{
	...
	public class PursuitBehavior extends Behavior 
	{
		...
		/**
		 * This behavior is similar to seek, however, the boid will "predict" movements of target boid. Opposite of Evade.
		 * @param	target
		 * @param	accuracy
		 */
		public function PursuitBehavior(target:Boid, accuracy:Number = 1.0) 
		{
			super();
